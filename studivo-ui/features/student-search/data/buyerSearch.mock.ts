...
export const mockBuyerSearchOffers: BuyerSearchOfferItem[] = [
  ...
  { _id: "offer_b2", requestId: "req_102", sellerId: "sell_88", imageURL: "", title: "كتب هندسة ميكانيكية - جامعة حلوان", description: "جميع كتب السنة الثالثة ميكانيكا باور بحالة ممتازة", seller: "أحمد مصطفى", status: "accepted", price: 4500, category: "books", createdAt: "2026-06-24T12:00:00Z" },
];